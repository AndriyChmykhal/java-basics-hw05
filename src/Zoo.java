...
public class Zoo {
    ...
    public static void acceptBird(List<? super FlyingBird> list, FlyingBird bird) {
        ...
        list.add(bird);
        System.out.println("Accepting a " + bird.toString() + " to a section");
    }
    ...
    public static void registerBird(List<? super Bird> list, Bird newBird) {
        System.out.println("Adding a to the birds list");
        list.add(newBird);

        for (Object generalBird : list) {
            System.out.println(generalBird.toString());
        }
    }
}
